...
print(labels)
print(len(labels))
all_list = for_(all_list, core_samples, labels, 0)
k = 0
kk = 0
...
for i in all_list[1:]:
    ...
    k += 1
plt.savefig(f"/root/git/Project_develop/figures/maxht_volume_fls_boxplot_newest_only_include_MCS.jpeg",
