...
def read_shuju():
    ...
    return r, maxht20, npixels_20_R, \
        maxht40, npixels_40_R, \
        Volume20 / 10000, Volume40 / 1000, \
        flashrate, flash_40
...
def read_shuju1():
    ...
    index_add1 = list(np.where(r >= 0))
    index_add2 = list(np.where(minir > 0))
    index_add3 = list(np.where(npixels_20 < 1000))
    index_add = list(set(index_add1[0]) & set(index_add2[0]) & set(index_add3[0]))
    """add"""
    r = r[index_add]
    maxht20 = maxht20[index_add]
    maxht30 = maxht30[index_add]
    ...
    Volume20 = n20_volume[index_add]
    Volume40 = n40_volume[index_add]
    return r, maxht20, maxht30, maxht40, npixels_20_R, npixels_30_R, npixels_40_R, flash_20, flash_30, flash_40, minir,\
