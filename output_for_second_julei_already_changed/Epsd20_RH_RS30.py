...
X = np.array(list(zip(ellip_20,  maxht20_minus_maxht40_divide_maxht20, npx40_divide_npx30
# Volume40_divide_20
...
for k in K:
    ...
    print(len(labels))
    cluster_centers = feature_normalize_back(kmeanModel.cluster_centers_, data_last[13], data_last[12]/data_last[1], data_last[19]
