...
from read_shuju import read_shuju1, read_shuju2
...
for k in K:
    ...
    kmeanModel = BisectingKMeans(n_clusters=k, init="k-means++", n_init=10, max_iter=1000 , tol=1e-8).fit(core_samples)
