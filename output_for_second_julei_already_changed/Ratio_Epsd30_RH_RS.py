...
X = np.array(list(zip(ellip_30, maxht20_minus_maxht40_divide_maxht20, npx40_divide_npx20, r
# Volume40_divide_20
...
for k in K:
    ...
    print(len(labels))
    cluster_centers = feature_normalize_back(kmeanModel.cluster_centers_, data_last[14], data_last[12]/data_last[1], data_last[18], data_last[0] 
...
plt.savefig("/root/git/Project_develop/manuscript_review/figures/Ratio_Epsd30_RH_RS.jpeg", bbox_inches="tight", dpi=400)
