...
<center> **If you want to run the codes immediately, you can search https://doi.org/10.24433/CO.6720035.v1. I have push the codes to codeocean and the codes are published now.** <br /> </center>

### **Insturction**

​    &ensp;&ensp;&ensp; 1.The collated database can be found in the reference. <br />
​    &ensp;&ensp;&ensp; 2.The files with **dismissed** in their names are not for the thesis right now, and the number of the fig is correspondent to thesis. <br />
​    &ensp;&ensp;&ensp; 3.These programs need to be modified before you run it. (The path of hdf files which you can download through the database in the reference) <br />
​    &ensp;&ensp;&ensp; 4.The Improved_Kmeans_algorithm is the core program to classify the thunderstorms. <br />
​    &ensp;&ensp;&ensp; 5.The Add_* are not coorepondent to this manuscript but may be useful in our future research in expand the research subjects (e.g., different regions (e.g. Maritime Continent and America) and satellites (e.g. FY-3G, GPM)). <br />
