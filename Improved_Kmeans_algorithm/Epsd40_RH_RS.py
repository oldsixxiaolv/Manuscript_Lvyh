...
X = np.array(list(zip(ellip_40, maxht20_minus_maxht40_divide_maxht20, npx40_divide_npx20, 
# Volume40_divide_20
                      ))).reshape(len(ellip_40), 3)
...
for k in K:
    ...
    print(len(labels))
    cluster_centers = feature_normalize_back(kmeanModel.cluster_centers_, data_last[15], data_last[12]/data_last[1], data_last[18] 
...
plt.savefig("/root/git/Project_develop/manuscript_review/figures/Epsd40_RH_RS_zhoubutu.jpeg", bbox_inches="tight", dpi=400)
